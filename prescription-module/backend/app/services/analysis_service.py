...
from app.models.schemas import MedicineAnalysis, DrugInteraction, MedicineInfo
...
If NO valid medicines are found, return empty array []."""
    ...
    try:
        # Use a slightly higher temperature to allow for better reasoning on ambiguous text,
        # but keep it low enough to prevent hallucinations.
        result = await _call_cerebras([
        ...
        for item in data:
            ...
            # Double-check: minimal length and not a common excluded word
